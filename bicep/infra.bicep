...
resource vm 'Microsoft.Compute/virtualMachines@2022-03-01' = {
  ...
  resource vmMountDriveExtension 'extensions@2022-08-01' = {
    ...
    properties: {
      settings: any({
        fileUris: [
          'https://raw.githubusercontent.com/betagouv/euphrosyne-tools-infra/bf5b0ffc3dd52400ac364b4075385f9295da4cf1/bicep/main.ps1'
      ...
      protectedSettings: any({
        commandToExecute: 'powershell .\\main.ps1 -AccountName ${accountName} -AccountPassword ${accountPassword} -FileShare ${fileShareName} -StorageAccountAccessKey ${storageAccount.listKeys().keys[0].value} -StorageAccount ${storageAccount.name} -FileShareProjectFolder ${fileShareProjectFolder}'
      })
